document.addEventListener('DOMContentLoaded', function(){
    ...
    let mobile_menu_open_toggler = document.querySelector('#mobile_menu_open_toggler');
    ...
    mobile_menu_open_toggler.addEventListener( 'click', function () {
        mobile_menu_main.classList.add('active');
    });
